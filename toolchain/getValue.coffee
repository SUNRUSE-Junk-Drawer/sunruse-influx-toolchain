...
module.exports = (tokenized, input, token, funct, log, logPrefix) ->
	if token is "input"
		if log
	...
	if funct.declarations[token]
		...
		return module.exports.compileExpression tokenized, input, funct.declarations[token], funct, log, logPrefix + "\t"
	if log
