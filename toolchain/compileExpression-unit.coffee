...
describe "compileExpression", ->
	...
	beforeEach ->	
		...
		spyOn(compileExpression, "getValue").and.callFake (_tokenized, _input, _token, _funct, _logs, _logPrefix, _cache) ->
		...
		spyOn(compileExpression, "findFunction").and.callFake (_tokenized, _input, _name, _logs, _logPrefix, _cache) ->
			expect(_tokenized).toBe tokenized
			expect(_cache).toEqual "Test Cache"
			if _logs
				expect(_logs).toBe logs
		...
		spyOn(compileExpression, "compileExpression").and.callFake (_tokenized, _input, _expression, _funct, _logs, _logPrefix, _cache) ->
			expect(_cache).toEqual "Test Cache"
			expect(_tokenized).toBe tokenized
	...
	describe "without logging", ->
		describe "given a chain", ->
			...
			it "returns falsy when the value cannot be resolved", ->
				...
				expect compileExpression tokenized, "Test Input", expression, funct, null, null, "Test Cache"
					.toBeFalsy()
	...
	describe "with logging", ->
		...
		describe "given a chain", ->
			...
			it "returns falsy when the value cannot be resolved", ->
				...
				expect compileExpression tokenized, "Test Input", expression, funct, logs, "Test Log Prefix", "Test Cache"
					.toBeFalsy()
