...
describe "getValue", ->
	...
	beforeEach ->
		...
		spyOn(getValue, "compileExpression").and.callFake (_tokenized, _value, _expression, _funct, _logs, logPrefix, cache) ->
	...
	describe "without logging", ->
		it "returns a value object when a primitive literal returning truthy is given", ->
			expect getValue tokenized, "Test Input", "Test Literal B", funct, null, null, "Test Cache"
				.toEqual
					score: 0
					primitive:
						type: "testPrimitiveB"
		...
		it "returns a value object when a primitive literal returning false is given", ->
			expect getValue tokenized, "Test Input", "Test Literal A", funct, null, null, "Test Cache"
				.toEqual
					score: 0
					primitive:
						type: "testPrimitiveA"
		...
		it "returns a value object when a primitive literal returning zero is given", ->
			expect getValue tokenized, "Test Input", "Test Literal C", funct, null, null, "Test Cache"
				.toEqual
					score: 0
					primitive:
						type: "testPrimitiveC"
		...
		it "returns a value object when a primitive literal returning null is given", ->
			expect getValue tokenized, "Test Input", "Test Literal D", funct, null, null, "Test Cache"
				.toEqual
					score: 0
					primitive:
						type: "testPrimitiveD"
		...
		it "returns a value object when a primitive literal returning empty string is given", ->
			expect getValue tokenized, "Test Input", "Test Literal E", funct, null, null, "Test Cache"
				.toEqual
					score: 0
					primitive:
						type: "testPrimitiveE"
		...
		it "returns a value object when a primitive literal returning NaN is given", ->
			expect getValue tokenized, "Test Input", "Test Literal F", funct, null, null, "Test Cache"
				.toEqual
					score: 0
					primitive:
						type: "testPrimitiveF"
		...
		it "returns the input when 'input' is given", ->
			expect getValue tokenized, "Test Input", "input", funct, null, null, "Test Cache"
				.toEqual "Test Input"
		it "calls compileExpression when the name of a declaration in the same function is given", ->
			expect getValue tokenized, "Test Input", "testDeclarationB", funct, null, null, "Test Cache"
				.toEqual "Test Compiled Expression"		
		it "returns falsy when no value can be resolved", ->
			expect getValue tokenized, "Test Input", "nonsense", funct, null, null, "Test Cache"
				.toBeFalsy()		
				
	describe "with logging", ->
		it "returns a value object when a primitive literal returning truthy is given", ->
			expect getValue tokenized, "Test Input", "Test Literal B", funct, logs, "Test Log Prefix", "Test Cache"
				.toEqual
					score: 0
					primitive:
						type: "testPrimitiveB"
		...
		it "returns a value object when a primitive literal returning false is given", ->
			expect getValue tokenized, "Test Input", "Test Literal A", funct, logs, "Test Log Prefix", "Test Cache"
				.toEqual
					score: 0
					primitive:
						type: "testPrimitiveA"
		...
		it "returns a value object when a primitive literal returning zero is given", ->
			expect getValue tokenized, "Test Input", "Test Literal C", funct, logs, "Test Log Prefix", "Test Cache"
				.toEqual
					score: 0
					primitive:
						type: "testPrimitiveC"
		...
		it "returns a value object when a primitive literal returning null is given", ->
			expect getValue tokenized, "Test Input", "Test Literal D", funct, logs, "Test Log Prefix", "Test Cache"
				.toEqual
					score: 0
					primitive:
						type: "testPrimitiveD"
		...
		it "returns a value object when a primitive literal returning empty string is given", ->
			expect getValue tokenized, "Test Input", "Test Literal E", funct, logs, "Test Log Prefix", "Test Cache"
				.toEqual
					score: 0
					primitive:
						type: "testPrimitiveE"
		...
		it "returns a value object when a primitive literal returning NaN is given", ->
			expect getValue tokenized, "Test Input", "Test Literal F", funct, logs, "Test Log Prefix", "Test Cache"
				.toEqual
					score: 0
					primitive:
						type: "testPrimitiveF"
		...
		it "returns the input when 'input' is given", ->
			expect getValue tokenized, "Test Input", "input", funct, logs, "Test Log Prefix", "Test Cache"
				.toEqual "Test Input"
			expect(logs).toEqual ["Test Log A", "Test Log B", "Test Log PrefixInitial value is the input."]
		it "calls compileExpression when the name of a declaration in the same function is given", ->
			expect getValue tokenized, "Test Input", "testDeclarationB", funct, logs, "Test Log Prefix", "Test Cache"
				.toEqual "Test Compiled Expression"		
		...
		it "returns falsy when no value can be resolved", ->
			expect getValue tokenized, "Test Input", "nonsense", funct, logs, "Test Log Prefix", "Test Cache"
				.toBeFalsy()								
