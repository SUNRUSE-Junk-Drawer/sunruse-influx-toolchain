module.exports = ->
	[
		module.exports.makeSwitch "int", (tokenized, cache, value) -> 
			"(" + (module.exports.codeCache tokenized, cache, value.properties.on) + ") ? (" + (module.exports.codeCache tokenized, cache, value.properties.b) + ") : (" + (module.exports.codeCache tokenized, cache, value.properties.a) + ")" 
